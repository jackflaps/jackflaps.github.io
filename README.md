...
This is jackflaps.net. It was built on [Jekyll Clean](https://github.com/scotte/jekyll-clean) but then I ripped it up a bunch to make it look the way I wanted.
